...
export default function DealerCard({ dealer }: { dealer: ApiDealerCard }) {
  ...
  return (
    <Link
      ...
      className="group flex h-full flex-col gap-4 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-[#f75d34]/30 hover:shadow-lg"
    >
      ...
      <div className="mt-auto flex items-center justify-between border-t border-gray-100 pt-3 text-xs">
        ...
        <span className="font-semibold text-[#f75d34] group-hover:translate-x-0.5 transition-transform">
          →
        </span>
      </div>
    </Link>

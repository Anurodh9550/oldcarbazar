    ...
    <div className="space-y-12">
      ...
      <section>
        ...
        <p className="mt-1 text-body-muted">
          We work with India&apos;s leading loan marketplaces to get you the
          fastest approval at the best rate.
        </p>
        <div className="mt-5 grid gap-4 sm:grid-cols-3">
          {Object.values(loanPartners).map((p) => (
            <div
              key={p.id}
      ...
      <section>
        ...
        <p className="mt-1 text-body-muted">
          Choose your preferred lender and click <strong>Check Eligibility</strong> to apply.
        </p>
